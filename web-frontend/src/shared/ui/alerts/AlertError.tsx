...
export const AlertError = ({
    ...
    return (
        <>
            <div
                className={clsx(
                    "flex w-full rounded-[10px] border-l-6 border-red-light bg-red-light-5 px-7 py-8",
                    "dark:bg-[#1B1B24] dark:bg-opacity-30 md:p-9",
                )}
            >
                <div className="mr-5 flex h-9 w-9 items-center justify-center rounded-lg bg-[#BC1C21]">
                    <svg
                        width="11"
                        height="11"
                        viewBox="0 0 11 11"
