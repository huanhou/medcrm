          ...
          <span className="relative">
            ...
            >
              <span className="absolute -z-1 inline-flex h-full w-full animate-ping rounded-full bg-red-light opacity-75"></span>
                ...
                {dropdownOpen && (
                    <div
                        className={`absolute -right-27 mt-7.5 flex h-[250px] w-75 flex-col rounded-xl border-[0.5px] border-stroke bg-white px-5.5 pb-5.5 pt-5 shadow-default dark:border-dark-3 dark:bg-gray-dark sm:right-0 sm:w-[364px]`}
                    >
